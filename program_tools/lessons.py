import re
from program_tools.config import clear_tags
from program_tools.lessons_with_desc import build_lesson_with_desc_type
...
def build_lesson_type(program: str) -> list[dict] | None:
